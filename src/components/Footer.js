               ...
               <div className="bg-dark text-light">
                <div className="row" style={{borderBottom: "2px solid white"}}>
                         <div className="col md 4">
                             <h3 className="h3"> Travelling App</h3>
                         </div>
                         ...
                         <div className="col md 4">
                             ...
                             <ul className="list-group">
                                ...
                                <li class="list-group-item bg-dark text-light">Mo.no:123654789</li>
                                <li class="list-group-item bg-dark text-light">Blog</li>
                                <li class="list-group-item bg-dark text-light">Web Chat</li>
                                <li class="list-group-item bg-dark text-light"><a href="#">Email-id:abc@gmail.com</a></li>
                             </ul>
                         </div>
                </div>
